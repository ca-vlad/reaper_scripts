...
function main()
  ...
  -- TODO: Add check for folder track

  -- Get original track depth
  ...
  -- local track_level = reaper.GetMediaTrackInfo_Value(original_track, 'P_PARTRACK')
  ...
  reaper.Undo_EndBlock("Select level one tracks", -1)
